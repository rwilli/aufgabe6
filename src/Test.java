...
public class Test {
	...
	public static void main(String[] args) {
		 ...
		 * Fabric4 is already in the map from before and Bob is added twice,
		 * so only the first is really added
		 */
		System.out.println();
		System.out.println("---Add fabrics to our map and look if they were really added---");
		 ...
		 */
		System.out.println();
		System.out.println("---get a fabric by key. returns null if the key isn't contained in the map---");
		System.out.println("Get fabric \"4\" by key:  " +mapFabrics.getValueByKey("4"));
		System.out.println("Get fabric \"Fabrik4\" by key:  " +mapFabrics.getValueByKey("Fabrik4"));
		...
		System.out.println("Is fabric as in the map? : " +mapFabrics.contains("as"));
		System.out.println("Is fabric Bob in the map? : " +mapFabrics.contains("Bob"));
		/*
